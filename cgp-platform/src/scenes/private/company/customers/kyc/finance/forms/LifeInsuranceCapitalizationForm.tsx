...
} from "../../../wealth/AssetCreation/LifeInsuranceCapitalizationForm";
import { LifeInsuranceCapitalizationFormData } from "../types";

interface LifeInsuranceCapitalizationFormProps {
  asset?: CustomerAsset;
  onSubmit: (data: LifeInsuranceCapitalizationFormData) => void;
  isLoading?: boolean;
}
...
export const LifeInsuranceCapitalizationForm = ({
  ...
  onSubmit,
  isLoading,
}: LifeInsuranceCapitalizationFormProps) => {
  const defaultValues: LifeInsuranceCapitalizationFormData = {
  ...
  const prefixField = "lifeInsuranceCapitalization-";
          ...
          <Controller
            ...
            render={({ field }) => (
              <div className="flex items-center space-x-2">
                ...
                <InputSwitch
                  inputId={`lifeInsuranceCapitalization-${field.name}`}
                  checked={field.value}
