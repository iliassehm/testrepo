...
} from "../../../wealth/AssetCreation/SCPIForm/index";
import { RockPaperFormData } from "../types";

interface RockPaperFormProps {
  asset?: CustomerAsset;
  onSubmit: (data: RockPaperFormData) => void;
  isLoading?: boolean;
}

export const RockPaperForm = ({
  asset,
  onSubmit,
  isLoading,
}: RockPaperFormProps) => {
  const defaultValues: RockPaperFormData = {
