...
interface MaternalParentsSectionProps {
  data?: CustomerRelationForm[];
  refetchRelationData: () => void;
  linkedRelations?: Customer[];
}

export default function MaternalParentsSection({
  data = [],
  refetchRelationData,
  linkedRelations,
}: MaternalParentsSectionProps) {
  ...
  return (
    <RelationSectionWrapper
      title={t("scenes.customers.kyc.formsTitle.maternalParents")}
      sectionName="maternalParents"
      state={state}
