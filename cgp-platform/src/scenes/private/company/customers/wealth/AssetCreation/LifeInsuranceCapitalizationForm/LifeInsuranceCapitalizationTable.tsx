...
import { LifeInsuranceCapitalizationFormData } from ".";
...
interface LifeInsuranceCapitalizationTableProps {
  form: UseFormReturn<LifeInsuranceCapitalizationFormData, unknown, undefined>;
  totalFees: number;
  investmentList: InvestmentInstrumentTableRow[];
  onSubmit: (values: InvestmentValues[]) => void;
}
export function LifeInsuranceCapitalizationTable(
  props: LifeInsuranceCapitalizationTableProps
) {
