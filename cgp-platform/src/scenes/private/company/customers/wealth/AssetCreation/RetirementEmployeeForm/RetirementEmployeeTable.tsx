...
import { RetirementEmployeeFormData } from ".";
...
interface RetirementEmployeeTableProps {
  form: UseFormReturn<RetirementEmployeeFormData, unknown, undefined>;
  totalFees: number;
  investmentList: InvestmentInstrumentTableRow[];
  onSubmit: (values: InvestmentValues[]) => void;
}
export function RetirementEmployeeTable(props: RetirementEmployeeTableProps) {
